...
def findalpharest(grammararr,k): """function to find alpha and rest values"""
...
def findbeta(grammararr,alpharest,l,m):   """function to find beta for corresponding alpha values"""
...
def formnewprod(grammararr,alpharest,beta,i,j): #function to print new production
    ...
    if(i<len(alpharest) and j<len(beta)):
        ...
        formnewprod(grammararr,alpharest,beta,0,0)
#print(*alpharest, sep='\n')
#print(*beta, sep='\n')
